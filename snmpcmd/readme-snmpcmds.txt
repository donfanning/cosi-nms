                        ...
                        README file for snmpcmds.pl
 
                      May 23, 2001 SNMP Commands ver 0.4
 
                          Copyright (C)1998-2001 
                     All Rights Reserved COE-IAE@cisco.com 
                      
 Issued Under the Mozilla Open Software License 
  ...
  CONTENTS 
  	...
  	Release Notes - 
  	Known Bugs Installation and Configuration - 
  	Package Content - 
  	Installation Notes - 
  	Pre-installation Tasks - 
  	Installation Steps - 
    Configuring Uninstalling snmpcmds.pl - 
  ...
  INTRODUCTION 
  ----------------------------------------------------------------------- 
  This lightweight CGI Perl module uses CGI_lite to support easy access to common SNMP 
  MIBs, Tables, and OIDs. The ability to bookmark MIB locations is provided by 
  the file snmpcmds.dat. 
  
  ----------------------------------------------------------------------- 
  SYSTEM REQUIREMENTS 
  ----------------------------------------------------------------------- 
  The SNMP Comands Perl script has been tested successfully on SunOS ver 5.6 and 
  Perl ver 5.005_03 built for sun4-solaris. To use SNMP Commands, the following 
  requirements must be met: * snmpcmds.dat must be in th edirectory path and contain 
  defined values * ucd-snmp must be installed (available from: sourceforge.net) 
  * Cisco mibs must be available (downlaoded and installed) * CGI_Lite.pm must 
  be installed 
  ...
  PACKAGE CONTENT 
  ----------------------------------------------------------------------- 
  SNMP Commands is supplied, as a Perl (.pl) script as part of a tar gzip archive, 
  and consists of the following files: 
  File 			Description 
  ---- 			----------- 
  devlist.dat   - device list 
  Readme.txt 	- this file 
  snmpcmds.dat 	- configuration file 
  snmpcmds.pl	- Perl script to invke SNMP Commands 
  ...
  1. If required, download and install ucd-snmp (sourceforge.net) 
  
  2. Download and install Cisco MIBs 
  
  3. Demonstrate that ucd-snmp is installed 
  and functioning- 
  for example, run snmpwalk from a command line: 
  :> snmpwalk  -m all maui-nas-01 underdog .1.3.6.1.2.1.1 2>/dev/null 
  
  Output similar to the 
  following confirms ucd-snmp is installed and functioning (NOTE: the command 
  line shown above prevents errors from being printed to the screen, if zero out 
  put is received, some error may be present that prevents the commnd from executing. 
  To enable printing of error messages, issue the command without the string "2>/dev/null") 
  
  ---Output: 
  system.sysDescr.0 = "Cisco Internetwork Operating System Software ..
  IOS(tm) 5300 Software (C5300-IS-M), 
  Version 12.0(7)T, RELEASE SOFTWARE (fc2)..Copyright(c) 1986-1999 by cisco Systems, Inc...
  Compiled Wed 08-Dec-99 20:25 by phanguye" 
  system.sysObjectID.0 = OID: enterprises.cisco.catProd.162 system.sysUpTime.sysUpTimeInstance 
  = Timeticks: (201822483) 23 days, 8:37:04.83 system.sysContact.0 = "ctobias@cisco.com" 
  system.sysName.0 = "maui-nas-01.maui-onions.com" system.sysLocation.0 = "" system.sysServices.0 
  = 78 system.8.0 = Timeticks: (0) 0:00:00.00 
  ---End Output
  
  4. Download snmp-commander package 
  (http://cosi-nms.sf.net) 
  ----------------------------------------------------------- 
  
  Installation tasks Follow this procedure to install SNMP Commander: 
  1. Un tar/gzip  the archive to the default directory:
   /opt/CSCOlwt 
  
  2. Edit $LWTCONF to point to the config folder 
  (for example:$LWTCONF = "/opt/CSCOlwt/conf") 
  
  3. Create/edit the file /opt/CSCOlwt/conf/lwt.cfg 
  
  4. Create/edit the file /opt/CSCOlwt/conf/snmpcmds.dat 
  containing the OIDs and SNMP verbs of ineterest. 
  
  5. Enable Apache server to serve 
  /opt/CSCOlwt/bin as /cgi-lwt 
  (makes the Network Supportal work) 
  
  6. Create a  device list (via device_lister.pl or by hand). 
  
  7. Test SNMP Commander 
 
 ----------------------------------------------------------------------- 
 CONFIGURING SNMP Commands 
 ----------------------------------------------------------------------- 
  1. To customize SNMP Commands, edit the file /opt/CSCOlwt/lwt.cfg 
  

 ======================================================================= 
 UNINSTALLING SNMP Commander 
 ======================================================================= 
  To uninstall SNMP Commands, remove the associated directories and files. 
  ...
  ************************************************************************ 
  ...
  ======================================================================= 
  Copyright 
  (c) 2001, Cisco COE-IAE, All rights reserved.
  Mozilla Public License Version
        ...
        3. Distribution Obligations. 
             ...
             likely to look for such a notice. You may choose to offer, and to charge a
             ...
             not attempt to limit or alter the recipient's rights in the Source Code version
        ...
        9. LIMITATION OF LIABILITY. 
             ...
             SUPPLIER OF ANY OF SUCH PARTIES, BE LIABLE TO YOU OR ANY
             ...
             SUCH PARTY'S NEGLIGENCE TO THE EXTENT APPLICABLE LAW
             PROHIBITS SUCH LIMITATION. SOME JURISDICTIONS DO NOT ALLOW
             THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL
             DAMAGES, SO THAT EXCLUSION AND LIMITATION MAY NOT APPLY
             TO YOU. 
        ...
        11. MISCELLANEOUS. 
             ...
             this Agreement shall be subject to the jurisdiction of the Federal Courts of
             the Northern District of California, with venue lying in Santa Clara County,
        ...
        EXHIBIT A. 
             ...
             License. 
			 The Original Code is ver 0.4.
  		    The Initial Developer of the Original Code is Kris Thompson.
  			Portions created by COE-IAE and Kris Thompson are Copyright (C) 1998-2001.
  			All Rights Reserved. Contributor(s): COE-IAE, Kris Thompson."

======================================================================= 
ABOUT COE-IAE 
======================================================================= 
  The Center of Excellence for Internet Access Engineering (COE-IAE) is a growing 
  team of professionals dedicated to the support of Internet Access Engineering 
  (IAE) through the development of knowledge based tools and procedures that enable 
  rapid delivery of high quality, integrated solutions to the user community. 
  The COE-IAE strives to: 
  * Create partnerships between Cisco, academia, industry, 
  and the local technical community to enable rapid IAE tools and techniques development. 
  
  * Foster the rapid transfer of generated knowledge to all who can use it. * 
  Develop "real world, best practice" IAE tools and techniques that successfully 
  scale to both Internet Service Providers (ISP) and enterprise computing environments 
  and enable greater product absorption. * Develop standards and practices for 
  future IAE certification programs. 
  
  COE-IAE website: http://mccain.ots.utexas.edu 
  COE-IAE email: lwt@extarnal.cisco.com
